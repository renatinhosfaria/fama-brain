...
origem: Facebook Ads
interesse_atual: >-
  Interesse registrado em imóvel, mas reenvio automático não realizado por regra
  de supressão operacional.
objecoes_ativas: []
proximo_passo: Manter status preservado no CRM; não enviar reenvio automático neste batch.
---
## Resumo
Cliente em reenvio inicial Reno/Fama suprimido por evidência de origem lead_automatico/autolead no CRM.

## Interesse atual
Interesse registrado em imóvel, mas reenvio automático não realizado por regra de supressão operacional.

## Objeções ativas


## Próximo passo
Manter status preservado no CRM; não enviar reenvio automático neste batch.
