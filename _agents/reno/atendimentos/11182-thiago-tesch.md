...
- Última interação relevante: cliente enviou saudação `Oi` no WhatsApp após visita/análise presencial já estar registrada; status preservado em `Agendamento`, sem envio por esta rotina silenciosa.
