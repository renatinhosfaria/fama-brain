...
canal: whatsapp
channel: whatsapp
cliente_id: pendente_crm_indisponivel
cliente_nome: Lua
created: '2026-05-08'
owner: reno
participants:
  - reno
  - Lua
status_curadoria: em_atendimento
tags:
  - reno
  - whatsapp
  - financiamento
...
## Diagnóstico atual
- Tipo desejado: casa.
- Condomínio fechado: preferência inicial, mas não obrigatório.
- Orçamento: até R$ 280 mil.
- Compra: financiamento.
- Entrada/FGTS: R$ 30–40 mil.

## Próximo passo
Validar renda familiar comprovada para estimar viabilidade de financiamento e então direcionar opções/visita presencial.
