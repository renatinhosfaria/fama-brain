...
supersedes: ["[[2026-04-29-reno-worker-inbound-whatsapp-criado]]", "[[2026-04-29-reno-handoff-pos-repescagem-worker-inbound]]"]
...
Esta remoção superou tanto a criação do worker quanto a decisão de handoff por aquele worker específico.
